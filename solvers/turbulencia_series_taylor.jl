...
# FFTW is used for the Fourier Transforms

# GLMakie is used for the interactive visualization of the vorticity magnitude

# ProgressMeter is used to display a progress bar during the simulation

# Statistics is used to compute the mean and standard deviation of the vorticity magnitude

# FFTW GLMakie Statistics ProgressMeter
